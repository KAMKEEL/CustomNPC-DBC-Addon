...
public class FormIcon extends Gui {
    ...
    private void setNonRacialForms(int state) {
        ...
        switch (state) {
            ...
            case DBCForm.Kaioken6:
                ...
                Aura aur = parent.dbcData.getAura();
                if (aur != null && aur.display.kaiokenColor != -1)
                    auraColor = new Color(aur.display.kaiokenColor);
                else
    ...
    private enum BodyIconType {
        HUMANOID, SS4, SS3, BUFF, OOZARU,

        ARC_FIRST, ARC_SECOND, ARC_THIRD, ARC_FOURTH, ARC_FIFTH,
    ...
    private enum HairIconType {
        HUMANOID, SS4, SS3, SS3_BUFF, OOZARU,
