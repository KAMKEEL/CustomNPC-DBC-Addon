...
public class GuiScriptAbility extends GuiNPCInterface implements GuiYesNoCallback, IGuiData, ITextChangeListener, ICustomScrollListener, IJTextAreaListener, ITextfieldListener {
    ...
    public final GuiNPCManageAbilities parent;
    public final Ability ability;
    private final AbilityScript scriptHandler;
    boolean loaded = false;

    private GuiScriptTextArea textArea;


    public GuiScriptAbility(GuiNPCManageAbilities parent, Ability ability) {
        ...
        this.scriptHandler = new AbilityScript();

        for (AbilityScript.ScriptType type : AbilityScript.ScriptType.values()) {
