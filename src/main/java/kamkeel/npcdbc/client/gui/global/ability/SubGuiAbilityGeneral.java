...
public class SubGuiAbilityGeneral extends GuiNPCInterface implements ISubGuiListener, GuiSelectionListener, ITextfieldListener {
    ...
    public void initGui() {
        ...
        if (scrollWindow == null) {
            scrollWindow = new GuiScrollWindow(this, x, y, 260 + rightOffset, 275, 0);
        } else {
            scrollWindow.xPos = x;
            scrollWindow.yPos = y;
            scrollWindow.clipWidth = 260 + rightOffset;
            scrollWindow.clipHeight = 275;
        }
        ...
        scrollWindow.addTextField(new GuiNpcTextField(103, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.kiCost + ""));
        ...
        scrollWindow.addTextField(new GuiNpcTextField(104, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.cooldown + ""));
...
//        scrollWindow.getTextField(105).min = 0;
        ...
        scrollWindow.addButton(new GuiNpcButtonYesNo(106, guiX + 100 + rightOffset, y, 60, 20, ability.multiUse));

        if (ability.multiUse) {
            y += 26;
            scrollWindow.addLabel(new GuiNpcLabel(1061, "ability.editor.maxUses", 3, y + 5));
            scrollWindow.getLabel(1061).color = 0xffffff;
            scrollWindow.addTextField(new GuiNpcTextField(106, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.maxUses + ""));
        ...
        scrollWindow.addButton(new GuiNpcButton(107, guiX + 100 + rightOffset, y, 60, 20, new String[]{"Cast", "Toggle", "Animated"}, ability.type.ordinal()));
        ...
        if (ability.type == Ability.Type.Animated) {
            ...
            scrollWindow.addButton(new GuiNpcButton(1071, guiX + 100 + rightOffset, y, 60, 20, "gui.select"));
        ...
        scrollWindow.addTextField(new GuiNpcTextField(109, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.width + ""));
        ...
        scrollWindow.addTextField(new GuiNpcTextField(110, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.height + ""));
        ...
        scrollWindow.addTextField(new GuiNpcTextField(111, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.iconX + ""));
        ...
        scrollWindow.addTextField(new GuiNpcTextField(112, this, this.fontRendererObj, guiX + 100 + rightOffset, y, 40, 20, ability.iconY + ""));
