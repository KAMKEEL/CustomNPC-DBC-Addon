...
public class SubGuiFormStackable extends SubGuiInterface implements ISubGuiListener, GuiSelectionListener,ITextfieldListener
{
    ...
    public void initGui()
    {
        ...
        GuiScrollWindow scrollWindow = new GuiScrollWindow(this, guiLeft, y, xSize - 9, ySize - 7, 0);
        ...
        if(stackable.kaiokenStackable){
            ...
            scrollWindow.addTextField(new GuiNpcTextField(23, this, guiLeft + 300, y, 50, 20, String.valueOf(stackable.kaiokenState2Factor)));
        ...
        if(stackable.uiStackable){
            ...
            scrollWindow.addTextField(new GuiNpcTextField(33, this, guiLeft + 300, y, 50, 20, String.valueOf(stackable.uiState2Factor)));
