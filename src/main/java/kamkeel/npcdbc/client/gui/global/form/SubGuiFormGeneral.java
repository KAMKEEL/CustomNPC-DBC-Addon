...
public class SubGuiFormGeneral extends SubGuiInterface implements ISubGuiListener, GuiSelectionListener, ITextfieldListener {
    ...
    public void initGui() {
        ...
        addButton(new GuiNpcButton(11, guiLeft + 88, y, 132, 20, "general.noForm"));
        if (form.parentID != -1) {
        ...
        addButton(new GuiNpcButton(12, guiLeft + 220, y, 16, 20, "X"));
        getButton(12).enabled = form.parentID != -1;
        addLabel(new GuiNpcLabel(12, "general.parentForm", guiLeft + 8, y + 5));

        y += 21;

        addButton(new GuiNpcButton(13, guiLeft + 88, y, 132, 20, "general.noForm"));
        if (form.childID != -1) {
        ...
        addButton(new GuiNpcButton(14, guiLeft + 220, y, 16, 20, "X"));
        ...
        addButton(new GuiNpcButton(30, guiLeft + 285, y, 55, 20, "gui.select"));
        addButton(new GuiNpcButton(301, guiLeft + 339, y, 16, 20, "X"));
        y += 23;
        ...
        addButton(new GuiNpcButton(31, guiLeft + 285, y, 55, 20, "gui.select"));
        addButton(new GuiNpcButton(311, guiLeft + 339, y, 16, 20, "X"));
    }
    ...
    public void buttonEvent(GuiButton guibutton) {
        ...
        if (button.id == 11) {
            this.setSubGui(new SubGuiSelectForm(11,false));
        }
        if (button.id == 12) {
            form.parentID = -1;
            initGui();
        ...
        if (button.id == 13) {
            this.setSubGui(new SubGuiSelectForm(13,false));
        }
        if (button.id == 14) {
            form.childID = -1;
            initGui();
