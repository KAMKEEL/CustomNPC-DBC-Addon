...
/**
 * I really fucking commited to the 1 tab per custom effect idea...
 * Too bad the GuiScriptInterface class doesn't support this by default.
 */
public class GuiDBCEffectScript extends GuiNPCInterface implements GuiYesNoCallback, IGuiData, ITextChangeListener, ICustomScrollListener, IJTextAreaListener, ITextfieldListener {
    ...
    public GuiDBCEffectScript(GuiNPCManageEffects parent, CustomEffect effect) {
