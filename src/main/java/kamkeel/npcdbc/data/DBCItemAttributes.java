...
public class DBCItemAttributes {
    ...
    public DBCItemAttributes(){
        ...
        AttributeRecalcEvent.registerListener(new IAttributeRecalcListener() {
            @Override
            public void onAttributesRecalculated(EntityPlayer entityPlayer, PlayerAttributeTracker playerAttributeTracker) {
