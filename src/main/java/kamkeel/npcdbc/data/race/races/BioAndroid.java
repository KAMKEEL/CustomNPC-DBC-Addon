...
public class BioAndroid {
    ...
    public static final Form MAX = FormBuilder.create(FormKey.of(BIO_ANDROID_NS, "max"))
        ...
        .display()
        .color(RaceDisplay.LAYER_BODY_CM, 0xc22023)
        .color(RaceDisplay.LAYER_BODY_C1, 0x9abe35)
        .color(RaceDisplay.LAYER_BODY_C2, 0xc22023)
        .color(RaceDisplay.LAYER_BODY_C3, 0x701b58)
        .customizable(true)
        .and()
        .build(FORMS);
