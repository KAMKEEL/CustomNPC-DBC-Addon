...
public enum DBCToggle {
    ...
    KAIOKEN("kaioken", "Kaioken", DBCSettings.KAIOKEN_ENABLED, 96, 0),
    FUSION("fusion", "Fusion", DBCSettings.FUSION_ENABLED, 144, 0),
    ...
    KI_WEAPON("ki_weapon", "Ki Weapon", DBCSettings.KI_WEAPON_TOGGLE, 288, 0,
        new int[]{0, 1}, new String[]{"Ki Blade", "Ki Scythe"},
        new int[][]{{288, 0}, {336, 0}}),
    POTENTIAL_UNLEASHED("potential_unleashed", "Potential Unleashed", DBCSettings.POTENTIAL_UNLEASHED, 384, 0),
    ULTRA_INSTINCT("ultra_instinct", "Ultra Instinct", DBCSettings.ULTRA_INSTINCT, 432, 0),
    GOD_OF_DESTRUCTION("god_of_destruction", "God of Destruction", DBCSettings.GOD_OF_DESTRUCTION, 336, 48);
    ...
    DBCToggle(String key, String displayName, int setting, int iconX, int iconY) {
        this(key, displayName, setting, iconX, iconY, null, null, null);
    }
