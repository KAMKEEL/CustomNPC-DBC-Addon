...
import kamkeel.npcdbc.network.packets.request.overlaychain.OverlayChainClonePacket;
import kamkeel.npcdbc.network.packets.request.overlaychain.OverlayChainDeletePacket;
import kamkeel.npcdbc.network.packets.request.overlaychain.OverlayChainSavePacket;
...
public class DBCPacketHandler {
    ...
    private void registerPlayerPackets() {
        ...
        PLAYER_PACKETS.registerPacket(new DBCSaveRaceProperties());
    ...
    private void registerRequestPackets() {
        ...
        REQUEST_PACKETS.registerPacket(new OverlayChainSavePacket());
        REQUEST_PACKETS.registerPacket(new OverlayChainClonePacket());
        REQUEST_PACKETS.registerPacket(new OverlayChainDeletePacket());
