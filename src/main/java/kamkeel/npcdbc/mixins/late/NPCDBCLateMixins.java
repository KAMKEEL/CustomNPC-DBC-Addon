...
public class NPCDBCLateMixins implements ILateMixinLoader {
    ...
    public List<String> getMixins(Set<String> loadedMods) {
        ...
        if (side == MixinEnvironment.Side.CLIENT) {
            ...
            mixins.add("npc.client.MixinGuiCNPCInventory");
            mixins.add("npc.client.MixinInventoryTabCustomNpc");
            ...
            mixins.add("dbc.client.MixinDBCTalkGui");
        ...
        mixins.add("npc.MixinScriptPlayerEventHandler");
        ...
        mixins.add("dbc.race.MixinJRMCorePacHanSRace");
        mixins.add("dbc.race.MixinJRMCoreHDBCRace");
        mixins.add("dbc.MixinJRMCoreHRaceStats");
        mixins.add("dbc.race.MixinComJrmcaRace");
